...
//    {
//        private readonly Dictionary<string, Action<T, TU>> _handlers = new Dictionary<string, Action<T, TU>>();
//        private readonly WeakReference<T> _source;
//        private readonly List<WeakReference<T>> _sourceList = new List<WeakReference<T>>();
